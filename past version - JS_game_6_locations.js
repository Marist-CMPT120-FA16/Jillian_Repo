      ...
      function Location(locationId, locationName, locationDescription, locationItem) {
      	...
      	this.toString = function() {
      		var banana = (currentLoc === 3 && bananaInCart === false) ? " There is a ripe yellow banana here." : " ";
      		var cupcake = (currentLoc === 1 && cupcakeInCart === false) ? " There is a cupcake with pink frosting here." : " ";
      		var pringles = (currentLoc === 6 && pringlesinCart === false) ? " There is a can of stranglely shaped chips here." : " ";
      		var message = "Location: " + this.name + "\n\n" + this.description + banana + cupcake + pringles;
      		return (message);
      	}
      	
     // 	function itemMessage() {
      		//if (currentLoc === 3 && bananaInCart === false) {
      		//	var item = " There is a ripe yellow banana here.";
      		//} else if (currentLoc === 1 && cupcakeInCart === false) {
      		//	var item = " There is a cupcake with pink frosting here.";
      		//} else if (currentLoc === 6 && pringlesinCart === false) {
      	//		var item = " There is a can of stranglely shaped chips here.";
      	//	} else {
      	//		item = " ";
      	//	}
